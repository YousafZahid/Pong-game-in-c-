...
public:
    ...
    void Window()
    {
        ...
        fontA.loadFromFile("G:/pong2/pong2/fonts/pong.ttf");
        texture.loadFromFile("cover.jpg");
        texture1.loadFromFile("Untitled.png");
    }
    ...
    {
        s2 << "Player2: " << score2;
        Stext1.setCharacterSize(30);
        Stext1.setPosition(sf::Vector2f(570, 10));
        Stext1.setFont(fontA);
        Stext1.setFillColor(sf::Color::Black);
        Stext1.setString(s2.str());
    ...
    void Winner()
    {
        if (score1 == 5)
        {
            ...
            BackOver();
            txtW.setFont(fontA);
            txtW.setString("Player 1 Is Winner!");
            txtW.Bold;
            txtW.setPosition(240, 130);
            txtW.setCharacterSize(40);
        ...
        if (score2 == 5)
        {
            ...
            BackOver();
            txtW1.setFont(fontA);
            txtW1.setString("Player 2 Is Winner!");
            txtW1.Bold;
            txtW1.setPosition(240, 130);
            txtW1.setCharacterSize(40);
...
int main()
{
    ...
    back.setSize(sf::Vector2f(800, 600));
    sf::Texture texture;
    texture.loadFromFile("G:/pong2/pong2/cover.jpg");
    texture.setSmooth(false);
    back.setTexture(&texture);
    // Starting Text on screen welcome note

    sf::Font font;
    font.loadFromFile("G:/pong2/pong2/fonts/pong.ttf");
    sf::Text txt;
    txt.setFont(font);
    txt.setString("Welcome To PONG");
    txt.Bold;
    txt.setPosition(140, 200);
    ...
    sf::Text txt1;
    txt1.setFont(font);
    txt1.setString("PRESS ENTER FOR MULTIPLAYER");
    txt1.Bold;
    txt1.setPosition(160, 300);
    txt1.setCharacterSize(35);
    txt1.setFillColor(sf::Color::White);
    // press Rshift to play with computer
    sf::Text txt2;
    txt2.setFont(font);
    txt2.setString("PRESS RSHIFT FOR SINGLE PLAYER");
    txt2.Bold;
    txt2.setPosition(157, 350);
    txt2.setCharacterSize(35);
